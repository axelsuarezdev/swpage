     ...
     <Layout>
       <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center content-center">
        <div className='space-y-6'>
         ...
         <p className='text-lg md:text-xl'>Discover the Star Wars universe like never before. Explore the <Link href="/films" className="text-amber-300">movies</Link> and meet the most important <Link href="/characters/1" className="text-amber-300">characters</Link> of this epic saga.</p>
        </div>
